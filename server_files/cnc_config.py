...
V_MIN = 600.0   # Стартовая скорость (шагов/сек)
V_MAX = 15000.0  # Максимальная скорость (шагов/сек)
A_MAX = 10000.0  # Ускорение (шагов/сек²)

# Параметры для паркинга - поиск концевика и и точное позиционирование, в шагах в секунду
V_FAST_HOME = 60000.0  # Максимальная скорость для быстрого набега на концевик
